...
詳細なfold別結果・外れ値除外統計・bootstrap CI・再現コマンドは [docs/plan011_v31_investor_evidence.md](docs/plan011_v31_investor_evidence.md) と [docs/plan011_v31_holdout_2024_2026.md](docs/plan011_v31_holdout_2024_2026.md) にまとめている。fold0-12 の資産推移・B&H比較・取引点チャートは [docs/figures/plan011_v31_folds0_12/README.md](docs/figures/plan011_v31_folds0_12/README.md) に固定している。
