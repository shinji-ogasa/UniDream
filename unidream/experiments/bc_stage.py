...
def build_bc_trainer(
    *,
    ...
    return BCPretrainer(
        ...
        active_target_weight=bc_cfg.get("active_target_weight", 1.0),
        active_target_margin=bc_cfg.get("active_target_margin", 0.02),
        neutral_exact_coef=bc_cfg.get("neutral_exact_coef", 0.0),
        neutral_exact_margin=bc_cfg.get("neutral_exact_margin", 0.02),
        ...
        route_active_rate_coef=bc_cfg.get("route_active_rate_coef", 0.0),
        route_active_rate_max=bc_cfg.get("route_active_rate_max", bc_cfg.get("active_rate_max", 0.0)),
        route_short_rate_coef=bc_cfg.get("route_short_rate_coef", 0.0),
        route_short_rate_max=bc_cfg.get("route_short_rate_max", bc_cfg.get("short_underweight_rate_max", 0.0)),
        route_neutral_rate_coef=bc_cfg.get("route_neutral_rate_coef", 0.0),
        route_neutral_rate_target=bc_cfg.get("route_neutral_rate_target", 0.0),
        inventory_recovery_coef=bc_cfg.get("inventory_recovery_coef", 0.0),
