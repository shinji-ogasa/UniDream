...
def prepare_bc_setup(
    *,
    ...
    actor.min_route_confidence_for_active = ac_cfg.get("min_route_confidence_for_active", 0.0)
    actor.active_rate_max = ac_cfg.get("active_rate_max", 0.0)
    actor.short_underweight_rate_max = ac_cfg.get("short_underweight_rate_max", 0.0)
    actor.rate_cap_active_eps = ac_cfg.get("rate_cap_active_eps", 0.05)
    actor.low_confidence_neutral_fallback = bool(ac_cfg.get("low_confidence_neutral_fallback", False))
    actor.recovery_fallback_gap = ac_cfg.get("recovery_fallback_gap", 0.05)
    actor.recovery_fallback_min_duration = ac_cfg.get("recovery_fallback_min_duration", 0.0)
