...
7. [statistical_gate_contract.md](statistical_gate_contract.md) — development-only statistical robustness gate contract (explicit trial count and even-fold CSCV requirement)
